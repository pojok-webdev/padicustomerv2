$(document).ready(function(){
    ...
    // MASKED INPUTS
        ...
        $(".mask_date").mask("99/99/9999 99:99");
    //FORM VALIDATION
   ...
   // TOOLTIPS
        ...
        // WYSIWIG HTML EDITOR    
         ...
         {
            $("#tSortable").dataTable({"iDisplayLength": 7, "aLengthMenu": [5,10,25,50,100,150,200], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": true }, null, null, null, null]});
