					...
					$.ajax({
						...
						$.ajax({
							...
							$.post('/clients/update',{
								id:$('#client_id').val(),
								status:'3',
								clientcategory:$('#clientcategory :selected').val()
							})
							.done(function(datax){
									var str = "";
									console.log("CLIENT CATEGORY",$('#clientcategory :selected').val());
									...
									.done(function(data){
										...
										$.ajax({
											url:'/surveys/updaterequestresume',
											type:'post',
											data:{
												description:$('#resume').val(),id:survey_request_id
											}
										})
										.done(function(data){
											console.log('Data update request resume',data)
											$.ajax({
												url:'/surveys/updatesiteresume',
												type:'post',
												data:{
													description:$('#resume').val(),id:$('#survey_site_id').val()
												}
											})
											.done(function(data){
												console.log('Data update site resume',data);
												window.location.href = thisdomain + 'surveys';
											})
											.fail(function(err){
												console.log('Error update resume',err);
											});
							...
							console.log("Error Client_site",err);
