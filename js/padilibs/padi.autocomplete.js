	...
	$(this).bind('keyup',function(e){
		...
		if((code!==40)&&(code!==38)&&(code!==13)){
			...
			$.each(settings.data,function(key,val){
				console.log("Index Of",val.toLowerCase().indexOf(thiselement.val().toLowerCase()))
				console.log("Ini dia ..",val,thiselement.val())
				...
				if(found){
					$("#btnsaveupstream").removeAttr("disabled")
				}else{
					$("#btnsaveupstream").attr("disabled",true)
				}
			});
		}
		if(code===13){
