...
<script type='text/javascript' src='/js/aquarius/prospects/edit.js'></script>
<body>
                ...
                <div class="span6">
                    ...
                    <div class="block-fluid">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span9">
								<?php echo form_dropdown('media',$medias,$this->media->getIndex($obj->media),'id="media" class="inp_prospect div_has_internet_connection" type="select"');?>
							</div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">Kecepatan:</div>
                            <div class="span9">
								<?php echo form_dropdown('speed',$speeds,$this->speed->getIndex($obj->speed),'id="speed" class="inp_prospect div_has_internet_connection" type="select"');?>
							</div>
                        </div>
                        <div class="row-form clearfix">
                        ...
                        <div class="row-form clearfix" id="durationspace">
                            ...
                            <div class="span9">
								<?php echo form_dropdown('duration',$durations,$this->duration->getIndex($obj->duration),'id="duration" class="inp_prospect div_has_internet_connection" type="select"');?>
							</div>
                        </div>
                        <div class="row-form clearfix" id="usageperiodspace">
                            <div class="span3">Lama penggunaan:</div>
                            <div class="span9">
								<?php echo form_dropdown('usage_period',$usage_periods,$this->usage_period->getIndex($obj->usage_period),'id="usage_period" class="inp_prospect div_has_internet_connection" type="select"');?>
							</div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">Jumlah Pengguna:</div>
                            <div class="span9">
								<?php echo form_dropdown('user_amount',$internet_users,$this->internet_user->getIndex($obj->user_amount),'id="user_amount" class="inp_prospect div_has_internet_connection" type="select"');?>
							</div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">Biaya:</div>
                            <div class="span9">
								<?php echo form_dropdown('fee',$internet_fees,$this->internet_fee->getIndex($obj->fee),'id="user_amount" class="inp_prospect div_has_internet_connection" type="select"');?>
							</div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">Operator:</div>
                            <div class="span9">
								<?php echo form_dropdown('operator',$operators,$this->operator->getIndex($obj->operator),'id="operator" class="inp_prospect div_has_internet_connection" type="select"');?>
							</div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">Akhir Kontrak:</div>
                            <?php
                            $endofcontract = $this->common->sql_to_human_date($obj->end_of_contract);
                            ?>
                            <div class="span9">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span9">
								<?php echo form_dropdown('problems',$problems,$this->problem->getIndex($obj->problems),'id="problems" class="inp_prospect div_has_internet_connection" type="select"');?>
							</div>
                        </div>
                        <div class="row-form clearfix">
