		...
		<div class="row">
			<table id="rpt" class="table">
				<thead>
					<tr>
						<th>No</th>
						<th onClick='orderlink("nofb","1")' class="pointer">No FB</th>
						<th onClick='orderlink("branch_id","1")' class="pointer">Cabang/Kota</th>
						<th onClick='orderlink("businesstype","1")' class="pointer">Jenis Bisnis</th>
						<th onClick='orderlink("period2","1")' class="pointer">Bulan Berakhir</th>
						<th onClick='orderlink("servicecategories","1")' class="pointer">Layanan</th>
						<th onClick='orderlink("description","1")' class="pointer">Keterangan</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td><?php echo $fb->branchcity;?></td>
						<td>
							<?php echo $fb->businesstype;?>
						</td>
						<td>
							<?php echo $fb->lastmonth;?>
						</td>
						<td>
							<?php echo $fb->services;?>
						</td>
						<td>
