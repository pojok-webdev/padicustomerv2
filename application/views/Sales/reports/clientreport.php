		...
		<div class="row">
			<table id="rpt" class="table">
				<thead>
					...
					<tr>
						<th>No</th>
						<th onClick='orderlink("create_date","1")' class='pointer'>Jenis Usaha</th>
						<th onClick='orderlink("name","1")' class='pointer'>Pelanggan</th>
						...
						<th onClick='orderlink("brn","1")' class='pointer'>Layanan</th>
					</tr>
				</thead>
				<tbody>
					<?php $c=0;?>
					...
					<tr>
						...
						<td>
							<?php echo $obj->branches;?>
						</td>
						<td>
							<?php echo $obj->cservices;?>
						</td>
					</tr>
					<?php }?>
				</tbody>
