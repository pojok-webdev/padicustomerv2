...
<html lang="en">
    ...
    <div id="dAddFollowup" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="content">
            <div class="breadLine">
                <ul class="breadcrumb">
                    ...
                    <li><a href="/suspects">Suspect</a> <span class="divider">></span></li>
                    ...
                    <div class="span6">
                        ...
                        <div class="block-fluid">
                            ...
                            <div class="row-form clearfix has_internet_connection">
                                ...
                                <div class="span9">
                                    <?php echo form_dropdown('media', $medias, $this->media->getIndex($obj->media), 'id="media" class="suspectfield hic" type="select"'); ?>
                                </div>
                            </div>
                            <div class="row-form clearfix has_internet_connection">
                                <div class="span3">Kecepatan:</div>
                                <div class="span9">
                                    <?php echo form_dropdown('speed', $speeds, $this->speed->getIndex($obj->speed), 'id="speed" class="suspectfield hic" type="select"'); ?>
                                </div>
                            </div>
                            <div class="row-form clearfix has_internet_connection">
                            ...
                            <div class="row-form clearfix has_internet_connection">
                                ...
                                <div class="span9">
                                    <?php echo form_dropdown('duration', $durations, $this->duration->getIndex($obj->duration), 'id="duration" class="suspectfield hic" type="select"'); ?>
                                </div>
                            </div>
                            <div class="row-form clearfix has_internet_connection">
                                <div class="span3">Lama penggunaan:</div>
                                <div class="span9">
                                    <?php echo form_dropdown('usage_period', $usage_periods, $this->usage_period->getIndex($obj->usage_period), 'id="usage_period" class="suspectfield hic" type="select"'); ?>
                                </div>
                            </div>
                            <div class="row-form clearfix has_internet_connection">
                                <div class="span3">Jumlah Pengguna:</div>
                                <div class="span9">
                                    <?php echo form_dropdown('user_amount', $internet_users, $this->internet_user->getIndex($obj->user_amount), 'id="user_amount" class="suspectfield hic" type="select"'); ?>
                                </div>
                            </div>
                            <div class="row-form clearfix has_internet_connection">
                                <div class="span3">Biaya:</div>
                                <div class="span9">
                                    <?php echo form_dropdown('fee', $internet_fees, $this->internet_fee->getIndex($obj->fee), 'id="fee" class="suspectfield hic" type="select"'); ?>
                                </div>
                            </div>
                            <div class="row-form clearfix has_internet_connection">
                                <div class="span3">Operator:</div>
                                <div class="span9">
                                    <?php echo form_dropdown('operator', $operators, $this->operator->getIndex($obj->operator), 'id="operator" class="suspectfield hic" type="select"'); ?>
                                </div>
                            </div>
                            <div class="row-form clearfix has_internet_connection">
                                <div class="span3">Akhir Kontrak:</div>
                                <div class="span9"><input type="text" placeholder="Akhir kontrak" value="<?php echo ($obj->end_of_contract == null) ? '' : $this->common->sql_to_human_date($obj->end_of_contract); ?>" id='end_of_contract'  name='end_of_contract' class='dtpicker suspectfield hic'/></div>
                            </div>
                            <div class="row-form clearfix has_internet_connection">
                                <div class="span3">Permasalahan yg sering dihadapi:</div>
                                <div class="span9">
                                    <?php echo form_dropdown('problems', $problems, $this->problem->getIndex($obj->problems), 'id="problems" class="suspectfield hic" type="select"'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="span6">
                        ...
                        <div class="block-fluid">
                            ...
                            <div class="row-form clearfix interested">
                                ...
                                <div class="span9">
                                    <?php echo form_dropdown('budget', $budgets, $this->budget->getId($obj->budget), 'id="budget" class="suspectfield" type="select"'); ?>
                                </div>
                            </div>
                            <div class="row-form clearfix interested">
                                <?php
                                $fu = $this->common->longsql_to_datepart($obj->follow_up);
                                ?>
                            ...
                            <div class="row-form clearfix interested">
                                <?php
                                $it = $this->common->longsql_to_datepart($obj->implementation_target);
                                ?>
        ...
        <script type='text/javascript' src='/js/aquarius/suspects/edit.js'></script>
    </body>
</html>
