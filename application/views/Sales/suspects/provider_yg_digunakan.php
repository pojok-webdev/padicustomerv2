				...
				<div class="span6">
					...
					<div class="block-fluid">
						<div class="row-form clearfix">
							...
							<div class="span7">
								<?php echo form_dropdown('media',$medias,$this->media->getIndex($objs->media),'id="media" class="inp_suspect" type="select"');?>
							</div>
						</div>
						<div class="row-form clearfix">
							<div class="span5">Kecepatan:</div>
							<div class="span7">
								<?php echo form_dropdown("speed",$speeds,$this->speed->getIndex($objs->speed),'id="speed" class="inp_suspect" type="select"');?>
							</div>
						</div>
						<div class="row-form clearfix">
							<div class="span5">Durasi Penggunaan Per Hari:</div>
							<div class="span7">
								<?php echo form_dropdown("duration",$durations,$this->duration->getIndex($objs->duration),'id="duration" class="inp_suspect" type="select"');?>
							</div>
						</div>
						<div class="row-form clearfix">
							<div class="span5">Periode Penggunaan:</div>
							<div class="span7">
								<?php echo form_dropdown("usage_period",$usage_periods,$this->usage_period->getIndex($objs->usage_period),'id="usage_period" class="inp_suspect" type="select"');?>
							</div>
						</div>
						<div class="row-form clearfix">
							<div class="span5">Jumlah PC Pengguna Internet:</div>
							<div class="span7">
								<?php echo form_dropdown("user_amount",$internet_users,$this->internet_user->getIndex($objs->user_amount),'id="user_amount" class="inp_suspect" type="select"');?>
							</div>
						</div>
					</div>
				</div>
				<div class="span6">
					...
					<div class="block-fluid">
						...
						<div class="row-form clearfix">
							...
							<div class="span7">
								<?php echo form_dropdown("fee",$internet_fees,$this->internet_fee->getIndex($objs->fee),'id="fee" class="inp_suspect" type="select"');?>
							</div>
						</div>
						<div class="row-form clearfix">
							<div class="span5">ISP/Operator yang digunakan:</div>
							<div class="span7">
								<?php echo form_dropdown("operator",$operators,$this->operator->getIndex($objs->operator),'id="operator" class="inp_suspect" type="select"');?>
							</div>
						</div>
						<div class="row-form clearfix">
						...
						<div class="row-form clearfix">
							...
							<div class="span7">
								<?php echo form_dropdown("problems",$problems,$this->problem->getIndex($objs->problems),'id="problems" class="inp_suspect" type="select"');?>
							</div>
						</div>
					</div>
				</div>
