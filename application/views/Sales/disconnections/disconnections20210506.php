                ...
                <div class="span12">
                    <div class="head clearfix">
                        ...
                        <ul class="buttons">
                            ...
                            <li>
                                <a href="#"><span class="isw-plus"></span> </a>
                                <ul class="dd-list">
                                    <li><a href="/disconnections/add_lookup"><span class="isw-right"></span> Permanen</a></li>
                                    <li><a href="/disconnections/add/temporer"><span class="isw-right"></span> Sementara</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
