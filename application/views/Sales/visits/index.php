								...
								<table class="table-bordered table-striped table-condensed flip-content" id="tvisit">
									<thead class="flip-content">
										<tr>
											...
											<th class="numeric">Tanggal Visit</th>
									...
									<tbody>
										...
										<tr>
											...
											<td class="numeric"><?php echo $obj->username;?></td>
											<td class="numeric"><?php echo $obj->visitdate1;?></td>
											<td class="center-text"><div class="btn btn-primary">Lihat Form</div></td>
										</tr>
										<?php }?>
									</tbody>
								</table>
