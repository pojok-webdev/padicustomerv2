...
<div class="container" id="fromHTMLtestdiv">
	<div class="page-header">
		...
		<div class="row padbot5">
			<div class="col-md-2 orgtext">
				<font style="color:red">LOKASI</font>
			</div>
			<div class="col-md-10">
				<?php echo $clientproperties->city;?>
			</div>
		</div>
		<div class="row padbot5">
		...
		<div class="row padbot5">
			<div class="col-md-2 orgtext">KEBUTUHAN</div><div class="col-md-10"><?php echo $clientproperties->servicename;?></div>
		</div>	  
	</div><!-- page header end -->
	<h3>1. Data Calon Pelanggan</h3>
	<div class="row padbot5">
		<div class="col-md-2 orgtext">Nama Calon Customer</div><div class="col-md-10" id="customername"><?php echo $clientproperties->name;?></div>
	</div>
	<div class="row padbot5">
		<div class="col-md-2 orgtext">Tipe Bisnis</div><div class="col-md-10"><?php echo $clientproperties->business_field;?></div>
	</div>
	<div class="row padbot5">
		<div class="col-md-2 orgtext">Kontak Teknis</div><div class="col-md-10">-</div>
	</div>
	<div class="row padbot5">
		<div class="col-md-2 orgtext">Alamat</div><div class="col-md-10"><?php echo $clientproperties->address;?></div>
	</div>
	<div class="row padbot5">
		<div class="col-md-2 orgtext">Tanggal Pelaksanaan</div><div class="col-md-10" id="surveydate">
		<?php echo (substr($clientproperties->execution_date,0,10)==="0000-00-00")?substr($clientproperties->survey_date,0,10):substr($clientproperties->execution_date,0,10);?>
		</div>
	</div>
	<div class="row padbot5">
	...
	<div class="row padbot50">
		<div class="col-md-12">
			<?php
			$stt = "";
				switch($clientproperties->resume){
					case "0":
