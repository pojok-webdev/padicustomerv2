...
<html lang="en">
    ...
    <script type='text/javascript' src='/js/aquarius/Sales/surveys/add.js'></script>
    <body>
                    ...
                    <div class="span6">
                        <div class="block-fluid without-head">
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span9">
                                    <?php echo form_dropdown("service_id",$services,$obj->service_interested_to,'class="surveyrequest clientsite" type="selectid" id="service_id');?>
                                </div>
                            </div>
                            <div class="row-form clearfix">
                    ...
                    <div class="span6 clearfix">
                        <div class="block-fluid without-head">
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span9">
                                    <textarea name="description" id="resume" class="surveyrequest surveysite myeditor_" type="textarea"><?php echo $obj->longresume ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
