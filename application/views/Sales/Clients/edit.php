...
<body>
    ...
    <div class="header">
        <a class="logo" href="/"><img src="/img/aquarius/logo.png" alt="PadiNET Application" title="PadiNET Application"/></a>
                ...
                <div class="span6">
                    ...
                    <div class="block-fluid">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span9">
								<?php echo form_dropdown('clientcategory',$clientcategories,$obj->clientcategory,'class="inp_client" type="select"');?>
							</div>
                        </div>
                        <div class="row-form clearfix">
