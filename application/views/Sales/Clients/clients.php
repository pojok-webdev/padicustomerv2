            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="head clearfix">
                        ...
                        <h1>Pelanggan</h1>
                        <div class="isw-download" id="download-installaddressclient" title='Download alamat instalasi'></div>
                    </div>
...
<script type='text/javascript' src='/js/aquarius/Sales/clients.js'></script>
    ...
    $('#download-client').click(function(){
        window.location.href = '/clients/clientdownload/'+d.getMonth()+'/'+d.getFullYear()
    });
    $('#download-installaddressclient').click(function(){
        window.location.href = '/clients/installaddressdownload';
    });
    </script>
</body>
</html>
