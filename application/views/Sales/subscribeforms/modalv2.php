			...
			<div class="span12">
				<div class="block-fluid without-head servicemodal">
					<div class="row-form clearfix">
						...
						<div class="span9">
							<?php echo form_dropdown("products",$products,1,"id='products' type='selectid' id='products'");?>
						</div>
					</div>
					<div class="row-form clearfix pdevice">
						<div class="span3">Perangkat</div>
						<div class="span9">
							<?php echo form_dropdown("devices",$devices,1,"id='devices' class='inp_fb_' type='selectid'");?>
						</div>
					</div>
					<div class="row-form clearfix pvas">
						<div class="span3">VAS</div>
						<div class="span9">
							<?php echo form_dropdown("vases",$vases,1,"id='vases' class='inp_fb_' type='selectid'");?>
						</div>
					</div>
					...
					<div class="row-form clearfix" id="dservicedescription">
