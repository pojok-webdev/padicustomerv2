	...
	<body>
		...
		<div class="container">
            ...
            <div class="row thisfooter1b lastfirstpage">
                <div class="col-xs-2"> <?php echo $documentstatus['siup']?>  SIUP</div>
                <div class="col-xs-2"> <?php echo $documentstatus['npwp']?>  NPWP</div>
                <div class="col-xs-2"> <?php echo $documentstatus['sppkp']?>  SPPKP</div>
                <div class="col-xs-2"> <?php echo $documentstatus['ktp penanggungjawab']?>  KTP PENANGGUNG JAWAB</div>
                <div class="col-xs-2"> <?php echo $documentstatus['ktp pemohon']?>  KTP PEMOHON</div>
                <div class="col-xs-2"> <?php echo $documentstatus['surat kuasa']?>  SURAT KUASA</div>
            </div>
            <div class="row">
