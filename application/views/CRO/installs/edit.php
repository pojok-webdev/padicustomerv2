                ...
                <div class="span6">
                    <div class="block-fluid without-head">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span9">
                                <input type="text" name="address" id="address" value="<?php echo $obj->client_site->client->address;?>"/>
                            </div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">Kota</div>
                            <div class="span9">
                                <input type="text" name="city" id="city" value="<?php echo $obj->client_site->client->city;?>"/>
                            </div>
                        </div>
                    </div>
                </div>
