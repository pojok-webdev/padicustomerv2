			...
			<div class="span6">
				<div class="block-fluid without-head">
					...
					<div class="row-form clearfix">
						...
						<div class="span5">
							<input type='text' class='datepicker' value="<?php echo date('d/m/Y');?>" name='followUpDate' id='followUpDate' />
						</div>
						<div class="span2">
			...
			<div class="span6">
				<div class="block-fluid without-head">
					<div class="row-form clearfix">
						...
						<div class="span9">
							<?php echo form_dropdown('cause', $ticketcausecategories, 0, 'id="causecategory" class="inp_ticket" type="select"'); ?>
						</div>
					</div>
					<div class="row-form clearfix">
...
<div id="dChooseBranch" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="infoModalLabel">Info</h3>
	</div>
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="block-fluid without-head">
					<div class="row-form clearfix">
						<div class="span9">
							<button type="button" class="btn togglebranch" data-toggle="button">Surabaya</button>
						</div>
						<div class="span3">&#9744</div>
					</div>
					<div class="row-form clearfix">
						<div class="span9">
							<button type="button" class="btn togglebranch" data-toggle="button">Jakarta</button>
						</div>
						<div class="span3">&#9744</div>
					</div>
					<div class="row-form clearfix">
						<div class="span9">
							<button type="button" class="btn togglebranch" data-toggle="button">Malang</button>
						</div>
						<div class="span3">&#9744</div>
					</div>
					<div class="row-form clearfix">
						<div class="span9">
							<button type="button" class="btn togglebranch" data-toggle="button">Bali</button>
						</div>
						<div class="span3">&#9745</div>
					</div>
				</div>
			</div>
			<div class="footer">
