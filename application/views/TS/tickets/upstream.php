				...
				<div class="row-fluid">
					<div class="span12">
						<table id="clientLookup" class="table" cellpadding="0" cellspacing="0" width="100%" >
							<thead>
								<tr><th>Nama</th><th>Alias</th><th>Alamat</th><th>Aksi</th></tr>
							</thead>
							<tbody>
								<?php foreach($clients as $client){?>
								<tr trid="<?php echo $client->id;?>" siteid="<?php echo $client->client_site_id;?>">
								<td class="cName"><?php echo $client->name?></td>
								<td class="cAlias"><?php echo $client->alias;?></td>
...
<div id="dChildPic" class="modal hide fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"> &times;</button>
				<h4><span id="picsitename"></span></h4>
			</div>
			<div class="modal-body">
				<div class="row-fluid">
					<div class="span12">
					<div class="row-form clearfix">
							...
							<div class="span8">
								<input type="text" id="childsite">
							</div>
						</div>
						<div class="row-form clearfix">
							<div class="span4">Address</div>
							<div class="span8">
								<input type="text" id="childsiteaddress">
							</div>
						</div>
						...
						<div class="row-form clearfix">
							...
							<div class="span8">
								<input type="text" id="childpic">
							</div>
						</div>
						<div class="row-form clearfix">
							<div class="span4">Telp PIC</div>
							<div class="span8">
								<input type="text" id="childpicphone">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal-footer">
				<button type="button" data-dismiss="modal" class="btn" id="btnsavepic">Simpan</button>
			</div>
		</div>
	</div>
</div>
