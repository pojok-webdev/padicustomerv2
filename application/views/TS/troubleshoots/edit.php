...
<body>
            ...
            <div class="row-fluid">
                <div class="span6">
                    <div class="block-fluid without-head">
                        ...
                        <?php
                        $request_date1 = $this->common->longsql_to_datepart($obj->request_date1);
                        ?>
                        <div class="row-form clearfix" id="downtimedetil">
                            <div class="span3">Rentang Waktu</div>
                            <div class="span3">
								<input type="text" id="request_date1" name="request_date1" class="datetimepickers dttime  datepicker texttohuman troubleshoot" value='<?php echo $this->common->longsql_to_human_date($obj->request_date1,'/');?>'/>
							</div>
							<div class="span2">
                        ...
                        <?php
                        $request_date2 = $this->common->longsql_to_datepart($obj->request_date2);
                        ?>
                        <div class="row-form clearfix" id="downtimedetil">
                            <div class="span3">s/d</div>
                            <div class="span3">
								<input type="text" id="request_date2" name="request_date2" class="datetimepickers dttime  datepicker texttohuman troubleshoot" value='<?php echo $this->common->longsql_to_human_date($obj->request_date2,'/');?>' />
							</div>
							<div class="span2">
    ...
    <script src='/js/aquarius/TS/troubleshoots/troubleshoot_edit.js'></script>
</body>
</html>
