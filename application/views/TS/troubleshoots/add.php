...
<body>
                ...
                <div class="span6">
                    <div class="block-fluid without-head">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span9">
								<input type="text" id="nameofmtype" name="nameofmtype" class="troubleshoot_" value="<?php echo $obj->clientname;?>"/>
                            </div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">Telp</div>
                            <div class="span9">
								<input type="text" id="phone" name="pic_phone" class="troubleshoot" value="<?php echo $obj->client_site->client->phone;?>"/>
                            </div>
                        </div>
                        <div class="row-form clearfix">
    ...
    <script src='/js/aquarius/TS/troubleshoots/troubleshoot_add.js'></script>
</body>
</html>
