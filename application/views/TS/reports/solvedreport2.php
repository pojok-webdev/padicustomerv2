				...
				<div class="well col-sm-12">
					<div class="col-sm-3">
						...
						<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="optage" value="5">&lt;3 hari</a></li>
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="optage" value="6">3 hari &le; x &le; 7 hari</a></li>
						  <li role="presentation" class="divider"></li>
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="optage" value="7">&gt; 7</a></li>
						</ul>
		...
		<script type="text/javascript">
			...
			$("#btnfilter").click(function(){
				...
				$(".optage").click(function(){
					...
					window.location.href = "/rpt/solvedreport/"+urlsegment(3)+"/"+order+"/"+branch+"/"+$(this).attr("value")+"/"+$("#startdate").attr("datetime")+"/"+$("#enddate").attr("datetime");
				});
