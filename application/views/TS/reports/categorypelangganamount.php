<html>
	...
	<body>
		...
		<input type="text" class="monthdatepicker" id="reportdate2" value ="<?php echo $dateselected2;?>">
			...
			<a href="/rpt/categorypelangganamount/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>/<?php echo $this->uri->segment(6);?>/<?php echo $this->uri->segment(7);?>/<?php echo $this->uri->segment(8);?>/<?php echo $this->uri->segment(9);?>" class="btn btn-success">Grafik</a>
		</h5>
		</div>
		<div class="row">
