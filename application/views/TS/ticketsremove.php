...
<html lang="en">
	...
	<body>
		...
		<?php $this->load->view("TS/tickets/mailSetting")?>
		<?php $this->load->view("TS/tickets/mailSettingGamas")?>
		<?php $this->load->view('TS/tickets/mailSettingPersonal')?>
		<?php $this->load->view('common/warningallfieldsfilled')?>
		<div class="header">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="head clearfix">
							...
							<select name="filtereskalasi" id="sfiltereskalasi" class="headcomponent">
								<option value=" ">All</option>
							...
							<span id="filterbranch">Filter Cabang</span>
							<select name="filterbranch" id="sfilterbranch" class="headcomponent">
								<option value=" ">All</option>
		...
		<script type='text/javascript' src='/js/aquarius/TS/tickets/tickets.js'></script>
		...
		<script type='text/javascript' src='/js/aquarius/TS/tickets/savenmail.js'></script>
	</body>
</html>
