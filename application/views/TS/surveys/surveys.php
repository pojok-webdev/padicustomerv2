		...
		<div class="content">
			<div class="breadLine">
				<ul class="breadcrumb">
					...
					<li><a href="/surveys">Survey</a> <span class="divider">></span></li>
								...
								<tbody>
									<?php foreach ($objs as $obj) { ?>
										<tr myid="<?php echo $obj->id; ?>">
											...
											<td><?php echo $this->survey_surveyor->get_names_by_survey_id($obj->survey_request_id); ?></td>
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu pull-right">
														<li class='btn_edit pointer' >
															<a href="/surveys/edit/<?php echo $obj->id;?>">Edit</a>
														</li>
														<li class="divider"></li>
														<li class='btn_reportx pointer'>
															<a href="/surveys/showreport/<?php echo $obj->id;?>">
																Report
															</a>
														</li>
													</ul>
