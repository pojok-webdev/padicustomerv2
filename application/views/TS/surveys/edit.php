...
<script type='text/javascript' src='/js/aquarius/TS/surveys/survey_edit2.js'></script>
<body>
			...
			<div class="row-fluid">
				...
				<div class="span6 clearfix">
					<div class="block-fluid without-head">
						...
						<?php
						$dtp = $this->common->longsql_to_datepart($obj->execution_date);
						?>
						<div class="row-form clearfix">
						...
						<div class="row-form clearfix">
							...
							<div class="span9"><textarea name="longresume" id="longresume" class="myeditor"><?php echo $obj->description?></textarea></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="span6 clearfix">
				...
				<h4>Detail Lokasi</h4>
					...
					<div class="row-form clearfix">
						...
						<div class="span9">
						<textarea name="description" id="site_descriptions" class="surveysite_ myeditor" type="textarea"><?php echo $obj->description?></textarea>
						</div>
					</div>
				</div>
			</div>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table images tBA" id="ba">
                            ...
                            <tbody>
                                ...
                                <tr myid=<?php echo $ba->id;?>>
                                    <td>
										<a class="fancybox" rel="group" href="/survey_sites/bapreview/<?php echo $ba->id;?>">
...
<!--			</div>
		...
		<script type='text/javascript' src='/js/aquarius/TS/surveys/edit.js'></script>
		<script type='text/javascript' src='/js/aquarius/TS/surveys/images.js'></script>
		<script type='text/javascript' src='/js/aquarius/TS/surveys/btses.js'></script>
		<script type='text/javascript' src='/js/aquarius/TS/surveys/resumes.js'></script>
		<script type='text/javascript' src='/js/aquarius/TS/surveys/operators.js'></script>
		<script type='text/javascript' src='/js/aquarius/TS/surveys/devices.js'></script>
		<script type='text/javascript' src='/js/aquarius/TS/surveys/materials.js'></script>
		<script type='text/javascript' src='/js/aquarius/TS/surveys/othersite.js'></script>
		<script type='text/javascript' src='/js/aquarius/TS/surveys/ba.js'></script>
