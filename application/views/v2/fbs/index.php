...
<body>
    <div class="header">
        <a class="logo" href="/">
            <img src="/img/aquarius/logo.png" alt="PadiApp" title="PadiApp - Form Berlangganan"/>
        </a>
                    ...
                    <div class="head clearfix">
                        ...
                        <ul class="buttons">
                            <li><a class="isw-plus"></a>
                                <ul class="dd-list">
                                    <li>
                                        <a href="/pfbses/add/<?php echo $clientid;?>">
                                            <span class="isw-documents"></span> Buat FB Baru
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                    ...
                                    <td>
                                        <div class="btn-group">                                        
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="divider"></li>
                                                <li><a class="pointer" href="/pfbses/edit/<?php echo $obj->ccc;?>">Edit FB</a></li>
                                                <li><a class="pointer" href="/pfbses/showreport/<?php echo $obj->ccc;?>">Lihat FB</a></li>
                                                <li><a class="pointer" href="/pfbses/printreport/<?php echo $obj->ccc;?>">Cetak FB</a></li>
                                                <li><a class="pointer" href="/fbs/hals/<?php echo $obj->ccc;?>">Cetak FB v2</a></li>
                                                <li class="divider"></li>
                                                <li><a class="pointer" href="/pfbses/copyfb/<?php echo $obj->ccc;?>/<?php echo $clientid;?>">Copy FB</a></li>
                                                <li class="divider"></li>
                                                <li><a class="pointer btnRemove">Hapus</a></li>
                                            </ul>
                                        </div>  
                                    </td>                                    
                                </tr>
