                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tMaintenance">
                            ...
                            <tbody>
                                ...
                                <tr class='<?php echo $color;?>' myid="<?php echo $obj->id;?>">
                                    ...
                                    <td>
                                        <h4>Pelaksanaan <?php echo $obj->maintenancedate;?></h4>
                                        <h5>
                                        Pengajuan <?php echo $obj->mdatetime;?>
                                        </h5>
                                    </td>
                                    <td class="name">
                                        <span class="tohuman"><?php echo $obj->name;?></span><br />
                                        <span>Period Type: <?php echo $obj->periodtype;?></span><br />
                                        <span>Schedule ID: <?php echo $obj->scheduleid;?></span>
                                    </td>
                                    <td class="tplogi" >
