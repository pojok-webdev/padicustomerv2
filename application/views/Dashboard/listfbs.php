				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/dashboard/bts">List FB</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-cogs"></i><?php echo $pageheaderlabel;?>
								</div>
								<div class="tools">
							...
							<div class="portlet-body flip-scroll">
								<table class="table-bordered table-striped table-condensed flip-content">
									...
									<tbody>
										...
										<tr>
											<td class="numeric"><?php echo $c;?></td>
											<td class="numeric"><?php echo $fb->nofb;?></td>
											<td class="numeric"><?php echo $fb->name;?></td>
											<td class="numeric"><?php echo $fb->service;?></td>
											<td class="numeric"><?php echo number_format($fb->fee);?></td>
											<td class="numeric"><?php echo $fb->activationdate;?></td>
										</tr>
										<?php $c++;?>
										<?php $total+=$fb->fee;?>
										<?php }?>
									...
									<tfoot>
										<tr>
											...
											<td class="numeric"><?php echo number_format($total);?></td>
											<td class="numeric"></td>
										</tr>
									</tfoot>
								</table>
