			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<?php }?>
						<a class="btn blue" href="<?php echo $navbut?>/0-1">Semua</a>
						<a class="btn yellow" href="<?php echo $navbut?>/1">u/ KPI</a>
						<a class="btn red" href="<?php echo $navbut?>/0">tidak KPI</a>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="caption">
							<h1><?php echo $headertext . ' ' . $category_label.' (' . humanize($username) . ') ' ;?></h1>
						</div>
						...
						<table class="table-bordered table-striped table-condensed flip-content" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td class=""><?php echo $visit->transport;?></td>
									<td><?php echo $visit->iscounted;?></td>
									<td>
							...
							<tfoot>
								<tr>
									<td colspan=8>Total Kunjungan <?php echo number_format($c-1);?></td>
								</tr>
							</tfoot>
						</table>
