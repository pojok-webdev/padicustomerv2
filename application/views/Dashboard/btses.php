				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/dashboard/bts">BTS</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption"><i class="icon-cogs"></i>BTS PadiNET</div>
								<div class="tools">
								...
								<table class="table-bordered table-striped table-condensed flip-content">
									<thead class="flip-content">
										<tr>
											<th>No</th>
											<th>Nama BTS</th>
											<th class="numeric">Kota</th>
											<th class="numeric">Lokasi</th>
											<th class="numeric">Jumlah AP</th>
											<th class="numeric">Jumlah Pelanggan</th>
											<th>Backbones</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td><?php echo $obj->bts?></td>
											<td class="numeric"><?php echo $obj->branch;?></td>
											<td class="numeric"><?php echo $obj->location?></td>
											<td class="numeric"><?php echo $obj->apcount?></td>
											<td class="numeric"><?php echo $obj->clientcount?></td>
											<td><a href="/dashboards/btsbackbones/<?php echo $obj->id;?>"><?php echo $obj->backbones;?></a></td>
										</tr>
										<?php }?>
									</tbody>
								</table>
