								...
								<table class="table-bordered table-striped table-condensed flip-content">
									<thead class="flip-content">
										<tr>
											<th>Backbone</th>
											<th>Startpoint</th>
											<th class="numeric">Endpoint</th>
											<th class="numeric">Lokasi</th>
											<th class="numeric">Kapasitas</th>
                                            <th>Jenis Backbone</th>
										</tr>
									</thead>
									<tbody>
										<?php foreach($objs as $obj){?>
										<tr>
											<td><?php echo $obj->backbone?></td>
											<td><?php echo $obj->startpoint?></td>
											<td class="numeric"><?php echo $obj->endpoint;?></td>
											<td class="numeric"><?php echo $obj->location?></td>
											<td class="numeric"><?php echo $obj->capacity?></td>
                                            <td><?php echo $obj->backbonetype?></td>
										</tr>
										<?php }?>
									</tbody>
								</table>
