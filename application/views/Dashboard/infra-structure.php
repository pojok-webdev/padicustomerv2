			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
						Infrastructure <small>Dashboard</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="/dashboard/bts">Infrastructure</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption"><i class="icon-cogs"></i>Infrastructure PadiNET</div>
								<div class="tools">
...
<iframe src="http://infrastructure.padinet.com" frameborder="0" height="600" width="100%"></iframe>
