			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
						Detail Install <small>Dashboard</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="/dashboards/installdetails">Detail Install</a></li>
						</ul>
		...
		jQuery(document).ready(function() {       
		   ...
		   App.init();
			...
			$('.showhistory').click(function(){
				...
				$.ajax({
					url:'/dashboards/getinstalldetailresult/'+id,
					dataType:'json'
				})
				.done(function(data){
					...
					$("#modallabel").html(" Status Install");
					switch(data.resume){
						case '0':
