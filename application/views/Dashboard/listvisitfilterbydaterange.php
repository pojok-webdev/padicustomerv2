...
<?php $this->load->view('Dashboard/head');?>
	...
	<div id="confirmation" class="modal hide">
		...
		<div class="modal-body" id="services">
			<h4>Apakah anda yakin hendak menghapus Visit dengan Kode </h4>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="/dashboards/salesfilterbydaterange/<?php echo $date1;?>/<?php echo $date2;?>">Sales</a>
								<i class="icon-angle-right"></i>
							</li>
							<li><a href="#">List Visit</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-cogs"></i>
									List Visit <?php echo '(' . humanize($username) . ') ' .$category_label;?> 
									<?php echo $this->common->sql_to_human_date($date1);?> - <?php echo $this->common->sql_to_human_date($date2);?> 
								</div>
								<div class="tools">
								...
								<table class="table-bordered table-striped table-condensed flip-content" id="tableOffers">
									...
									<tbody>
										...
										<tr offer_id="<?php echo $offer->id;?>">
											...
											<td class="showservices"><?php echo $offer->aim;?></td>
											<td class="showservices"><?php echo $this->common->sql_to_human_datetime($offer->visitstart);?></td>
											<td class="showservices"><?php echo $this->common->sql_to_human_datetime($offer->visitfinish);?></td>
											<td><?php echo $offer->transport;?></td>
										</tr>
										<?php $c++;?>
										<?php }?>
									</tbody>
									<tfoot>
										<tr>
											<td colspan=8>TOTAL VISIT: <?php echo number_format($c-1);?></td>
										</tr>
									</tfoot>
								</table>
							</div>
