			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
						Detail Survey <small>Dashboard</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li>
								<a href="/dashboards/survey">Survey</a>
								<i class="icon-angle-right"></i>
							</li>
							<li><a >Detail</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box green">
							<div class="portlet-title">
                                ...
                                Detail Survey PadiNET <?php echo $period . ' ' . $category?></div>
								<div class="tools">
		...
		jQuery(document).ready(function() {       
		   ...
		   App.init();
			...
			$('.showhistory').click(function(){
				...
				$("#modallabel").html(" Status Survey");
				$.ajax({
					url:'/dashboards/getsurveydetailresult/'+id,
					dataType:'json'
				})
				.done(function(data){
