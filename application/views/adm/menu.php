...
<div class="menu padimenu">
	...
	<ul class="navigation">
		...
		<?php if(($this->session->userdata["role"]==="TS")||($this->session->userdata["role"]=="Sales")||($this->session->userdata["role"]==="EOS")){?>
	...
	<li class="<?php echo $this->common->getMenuStatus($menuFeed,array('schedules'));?>">
		...
		<?php }?>
		<?php if(padi_inrole(array('sm-farmer','farmer','ts','field'))&&($this->session->userdata["role"]!=="CRO")){?>
		...
		<?php }?>
		<?php if(($this->session->userdata["role"]==="CRO")&&(false)){?>
