<?php
	...
	function maintenanceTemplate($id,$clientname){
		...
		$bodytext .= '<td style="text-align:center">';
		$bodytext .= '<font color="black">';
		$bodytext .= '<a href="'.$baseurl.'pmaintenanceschedules/edit/'.$id.'" style="font-family:Arial, Helvetica, sans-serif;font-size:13px;text-decoration:none;padding:5px 10px;color:white;background-color:#000;">Masuk PadiApp &raquo;</a>';
		$bodytext .= '</font>';
		$bodytext .= '</td>';
		$bodytext .= '</tr>';
