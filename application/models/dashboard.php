...
class Dashboard extends CI_Model{
    ...
    function getdailytickets($category,$date,$status,$branch_id='0'){
        ...
        $sql.='and a.branch_id in ('.$branch_id.') ';        $sql.= "and b.status = '" . $status . "' ";
    ...
    function getweeklytickets($category,$date,$status,$branch_id='0'){
        $sql = "select count(b.kdticket)cnt from clients a left outer join tickets b on b.client_id=a.id ";
    ...
    function getmonthlytickets($category,$date,$status,$branch_id='0'){
        $sql = "select count(b.kdticket)cnt from clients a left outer join tickets b on b.client_id=a.id ";
        $sql.= "where date(create_date)>date_sub('".$date."',interval dayofmonth('".$date."') day) ";
        $sql.='and a.branch_id in ('.$branch_id.') ';        
    ...
    function getquarterlytickets($category,$date,$status,$branch_id='0'){
        $sql = "select count(b.kdticket)cnt from clients a left outer join tickets b on b.client_id=a.id ";
    ...
    function getyearlytickets($category,$date,$status,$branch_id='0'){
        $sql = "select count(b.kdticket)cnt from clients a left outer join tickets b on b.client_id=a.id ";
    ...
    function getdailysurveys($category,$date,$branch_id='0'){
        $sql = "select count(a.id)cnt ";
        $sql.= "from survey_requests a ";
        $sql.= "left outer join clients b on b.id=a.client_id ";
        $sql.= "where  date_format(a.create_date,'%Y-%m-%d')=date_format('".$date."','%Y-%m-%d')";
        $sql.='and b.branch_id in ('.$branch_id.') ';
        if($category=='0'){
            $sql.= "and b.clientcategory not in  ('1','2','3','4','5') ";
        }else{
            $sql.= "and b.clientcategory = '".$category."' ";
        }
        $ci = & get_instance();
        $que = $ci->db->query($sql);
        $res = $que->result();
    ...
    function getweeklysurveys($category,$date,$branch_id='0'){
        $sql = "select count(a.id)cnt ";
        $sql.= "from survey_requests a ";
        $sql.= "left outer join clients b on b.id=a.client_id ";
        $sql.= "where  date_format(a.create_date,'%Y-%m-%d')<=date_format('".$date."','%Y-%m-%d') ";
        $sql.= "and ";
        $sql.= "(FLOOR((DayOfMonth('".$date."')-1)/7)+1)  = (FLOOR((DayOfMonth(a.create_date)-1)/7)+1)";
        $sql.= "and month(date(a.create_date))=month('".$date."') and year(a.create_date)=year('".$date."') ";
        $sql.='and b.branch_id in ('.$branch_id.') ';
        if($category=='0'){
            $sql.= "and b.clientcategory not in  ('1','2','3','4','5') ";
        }else{
    ...
    function getmonthlysurveys($category,$date,$branch_id='0'){
        $sql = "select count(a.id)cnt ";
        $sql.= "from survey_requests a ";
        $sql.= "left outer join clients b on b.id=a.client_id ";
        $sql.= "where  date_format(a.create_date,'%Y-%m-%d')<=date_format('".$date."','%Y-%m-%d') ";
        $sql.= "and month(date(a.create_date))=month('".$date."') ";
        $sql.= "and year(a.create_date)=year('".$date."') ";
        $sql.='and b.branch_id in ('.$branch_id.') ';        if($category=='0'){
            $sql.= "and b.clientcategory not in  ('1','2','3','4','5') ";
        }else{
            $sql.= "and b.clientcategory = '".$category."' ";
        }
    ...
    function getquarterlysurveys($category,$date,$branch_id='0'){
        $sql = "select count(a.id)cnt ";
        $sql.= "from survey_requests a ";
        $sql.= "left outer join clients b on b.id=a.client_id ";
        $sql.= "where date_format(a.create_date,'%Y-%m-%d')<=date_format('".$date."','%Y-%m-%d') ";
        ...
        $sql.='and b.branch_id in ('.$branch_id.') ';
        if($category=='0'){
            $sql.= "and (b.clientcategory not in  ('1','2','3','4','5') or b.clientcategory is null )";
        }else{
            $sql.= "and b.clientcategory = '".$category."' ";
        }
        $ci = & get_instance();
    ...
    function gettotaldailysurveys($date,$branch_id = '0'){
        $sql = "select count(a.id)cnt ";
        $sql.= "from survey_requests a ";
        $sql.= "left outer join clients b on b.id=a.client_id ";
        $sql.= "where  date_format(a.create_date,'%Y-%m-%d')=date_format('".$date."','%Y-%m-%d')";
    ...
    function gettotalweeklysurveys($date,$branch_id = '0'){
        $sql = "select count(a.id)cnt ";
        $sql.= "from survey_requests a ";
        $sql.= "left outer join clients b on b.id=a.client_id ";
        $sql.= "where  date_format(a.create_date,'%Y-%m-%d')<=date_format('".$date."','%Y-%m-%d') ";
    ...
    function gettotalmonthlysurveys($date,$branch_id = '0'){
        $sql = "select count(a.id)cnt ";
        $sql.= "from survey_requests a ";
        $sql.= "left outer join clients b on b.id=a.client_id ";
        $sql.= "where  date_format(a.create_date,'%Y-%m-%d')<=date_format('".$date."','%Y-%m-%d') ";
    ...
    function gettotalquarterlysurveys($date,$branch_id = '0'){
        $sql = "select count(a.id)cnt ";
        $sql.= "from survey_requests a ";
        $sql.= "left outer join clients b on b.id=a.client_id ";
        $sql.= "where date_format(a.create_date,'%Y-%m-%d')<=date_format('".$date."','%Y-%m-%d') ";
    ...
    function gettotalyearlysurveys($date,$branch_id = '0'){
        $sql = "select count(b.id)cnt from clients a left outer join survey_requests b on b.client_id=a.id ";
        $sql.= "where date(create_date)>=date_sub('".$date."',interval dayofyear('".$date."') day) ";
        $sql.= "and year(date(create_date))=year('".$date."') ";
        $sql = "select count(a.id)cnt ";
    ...
    function getdailyinstalls($category,$date,$branch_id='0'){
    ...
    function getweeklyinstalls($category,$date,$branch_id='0'){
        $sql = "select count(c.id)cnt from clients a left outer join client_sites b on b.client_id=a.id ";
        $sql.= "left outer join install_requests c on c.client_site_id=b.id ";
    ...
    function getmonthlyinstalls($category,$date,$branch_id='0'){
        $sql = "select count(c.id)cnt from clients a left outer join client_sites b on b.client_id=a.id ";
        $sql.= "left outer join install_requests c on c.client_site_id=b.id ";
    ...
    function getquarterlyinstalls($category,$date,$branch_id='0'){
        $sql = "select count(c.id)cnt from clients a left outer join client_sites b on b.client_id=a.id ";
        $sql.= "left outer join install_requests c on c.client_site_id=b.id ";
    ...
    function getyearlyinstalls($category,$date,$branch_id='0'){
        $sql = "select count(c.id)cnt from clients a left outer join client_sites b on b.client_id=a.id ";
        $sql.= "left outer join install_requests c on c.client_site_id=a.id ";
    ...
    function getdailytroubleshoots($category,$date,$branch_id){
        $sql = 'select count(a.id)cnt from troubleshoot_requests a ';
        $sql.= 'left outer join client_sites b on b.id=a.client_site_id ';
        $sql.= 'left outer join clients c on c.id=b.client_id ';
        $sql.= 'where date_format(a.create_date,"%Y-%m-%d")=date_format("'.$date.'","%Y-%m-%d")';
        if($category=='0'){
            $sql.= "and (c.clientcategory not in  ('1','2','3','4','5') or c.id is null)  ";
        }else{
            $sql.= "and c.clientcategory = '".$category."' ";
        }
        $sql.= 'and branch_id in ('.$branch_id.') ';
        $ci = & get_instance();
        $que = $ci->db->query($sql);
        $res = $que->result();
        return $res[0];
    }
    function getweeklytroubleshoots($category,$date,$branch_id){
        $sql = "select count(a.id)cnt ";
        $sql.= "from troubleshoot_requests a ";
        $sql.= "left outer join client_sites b on b.id=a.client_site_id ";
        $sql.= "left outer join clients c on c.id=b.client_id ";
        $sql.= "where date_format(a.create_date,'%Y-%m-%d')<=date_format('".$date."','%Y-%m-%d') ";
        $sql.= "and (FLOOR((DayOfMonth('".$date."')-1)/7)+1)  = (FLOOR((DayOfMonth(a.create_date)-1)/7)+1) ";
        $sql.= "and date_format(a.create_date,'%Y-%m')=date_format('".$date."','%Y-%m')";
    ...
    function getmonthlytroubleshoots($category,$date,$branch_id=0){
        $sql = "select count(a.id)cnt ";
        $sql.= "from troubleshoot_requests a ";
        $sql.= "left outer join client_sites b on b.id=a.client_site_id ";
        $sql.= "left outer join clients c on c.id=b.client_id ";
    ...
    function getquarterlytroubleshoots($category,$date,$branch_id=0){
        $sql = "select count(a.id)cnt ";
        $sql.= "from troubleshoot_requests a ";
        $sql.= "left outer join client_sites b on b.id=a.client_site_id ";
        $sql.= "left outer join clients c on c.id=b.client_id ";
        $sql.= "where date_format(a.create_date,'%Y-%m-%d')<=date_format('".$date."','%Y-%m-%d') ";
        $sql.= "and quarter(date(a.create_date))=quarter('".$date."') and year(a.create_date)=year('".$date."') ";
        $sql.= "and date_format(a.create_date,'%Y')=date_format('".$date."','%Y')";
    ...
    function getyearlytroubleshoots($category,$date,$branch_id=0){
        $sql = "select count(a.id)cnt ";
        $sql.= "from troubleshoot_requests a ";
        $sql.= "left outer join client_sites b on b.id=a.client_site_id ";
        $sql.= "left outer join clients c on c.id=b.client_id ";
    ...
    function gettotaldailytroubleshoots($date,$branch_id=0){
        $sql = 'select count(a.id)cnt from troubleshoot_requests a ';
        $sql.= 'left outer join client_sites b on b.id=a.client_site_id ';
        $sql.= 'left outer join clients c on c.id=b.client_id ';
        $sql.= 'where date_format(a.create_date,"%Y-%m-%d")=date_format("'.$date.'","%Y-%m-%d") ';
    ...
    function gettotalweeklytroubleshoots($date,$branch_id=0){
        $sql = "select count(a.id)cnt ";
        $sql.= "from troubleshoot_requests a ";
        $sql.= "left outer join client_sites b on b.id=a.client_site_id ";
        $sql.= "left outer join clients c on c.id=b.client_id ";
    ...
    function gettotalquarterlytroubleshoots($date,$branch_id=0){
        $sql = "select count(a.id)cnt ";
        $sql.= "from troubleshoot_requests a ";
        $sql.= "left outer join client_sites b on b.id=a.client_site_id ";
        $sql.= "left outer join clients c on c.id=b.client_id ";
    ...
    function gettotalmonthlytroubleshoots($date,$branch_id=0){
        $sql = "select count(a.id)cnt ";
        $sql.= "from troubleshoot_requests a ";
        $sql.= "left outer join client_sites b on b.id=a.client_site_id ";
        $sql.= "left outer join clients c on c.id=b.client_id ";
    ...
    function gettotalyearlytroubleshoots($date,$branch_id=0){
        $sql = "select count(a.id)cnt ";
        $sql.= "from troubleshoot_requests a ";
        $sql.= "left outer join client_sites b on b.id=a.client_site_id ";
        $sql.= "left outer join clients c on c.id=b.client_id ";
    ...
    function getsalesbranchesbydaterange($date1,$date2){
        ...
        $sql.= " where visitdate >= '" . $date1 . "' and date(visitdate)<='" . $date2 . "'  ";
        ...
        $sql.= " offerdate >= '" . $date1 . "' and date(offerdate)<='" . $date2 . "' ";
...
//        $sql.= "group by a.id,username,basebranch,b.branch_id ";
    ...
    function getlistoffersfilterbydate($date1,$date2,$sale_id,$branch_id){
        ...
        $sql.= "where sale_id=".$sale_id." and date(offerdate) >= '".$date1."' and date(offerdate)<='".$date2."' ";
    ...
    function getlistvisitsfilterbydate($date1,$date2,$sale_id,$branch_id,$iscounted){
        ...
        $sql.= "where sale_id=".$sale_id." and date(visitdate) >= '".$date1."' and date(visitdate)<='".$date2."' ";
        $sql.= "and branch=".$branch_id." ";
    ...
    function getbranchesbydaterange($date1,$date2){
        ...
        $sql.= "where date(visitdate)> '" . $date1 . "' and date(visitdate)<='" . $date2 . "' ";        
        $sql.= "and iscounted='1' ";
        ...
        $sql.= "where date(offerdate) > '" . $date1 . "' and date(offerdate)<='" . $date2 . "'  ";
    ...
    function getnationalbydaterange($date1,$date2){
        ...
        $sql.= " where date(visitdate)> '".$date1."' and date(visitdate)<='".$date2."' and iscounted='1' )A ";
        $sql.= " on A.x=Z.x ";
        $sql.= "left outer join ";
        $sql.= "(select 'x' X, count(id)cnt from offers ";
        $sql.= " where date(offerdate) > '".$date1."' and date(offerdate)<='".$date2."') B ";
        $sql.= " on B.x=Z.x ";
        $sql.= "left outer join ";
        $sql.= "(select 'x' x,count(id) cnt from visits ";
        $sql.= " where date(visitdate)> '".$date1."' and date(visitdate)<='".$date2."' and iscounted='0' )C ";
        $sql.= " on C.x=Z.x ";
        $ci = & get_instance();
        $que = $ci->db->query($sql);
        return array(
    ...
    function getticketdetails($period,$category,$branch_id='0'){
        $branch_id = ($this->uri->total_segments()>4)?implode(',',explode('-',$this->uri->segment(5))):0;
        $date = date("Y-m-d");
        ...
        if($branch_id<>'0'){
            $sql.= "and (";
            $sql.= " (b.branch_id in (".$branch_id."))or ";
            $sql.= " (d.branch_id in (".$branch_id."))or ";
            $sql.= " (h.branch_id in (".$branch_id."))or ";
            $sql.= " (f.branch_id in (".$branch_id."))or ";
            $sql.= " (c.branch_id_ in (".$branch_id."))) ";
        }
        $sql.= "and year(a.create_date)=year('".$date."')";
        $ci = & get_instance();
        $que = $ci->db->query($sql);
    ...
    function getsurveydetails($yearfilter,$period,$category,$branch_id){
        
        $date = date("Y-m-d");
        $date = $yearfilter;
        $branch_id = implode(",",explode("-",$branch_id));
        $sql = "select distinct a.id, ";
        $sql.= "b.address, b.name clientname from survey_requests a ";
        $sql.= "left outer join clients b on b.id=a.client_id ";
        if($category == '0'){
            $sql.= "where (b.clientcategory not in ('1','2','3','4','5') or b.clientcategory is null) ";
        }else{
            $sql.= "where b.clientcategory = '".$category."' ";
        }        
        switch ($period){
    ...
    function getinstalldetails($period,$category,$branch_id = '0'){
        $date = date("Y-m-d");
        $sql = "select distinct a.id, ";
        ...
        $sql.= "and year(a.create_date)=year('".$date."') ";
        $sql = 'select c.id,a.name clientname,a.address,a.city from clients a left outer join ';
        $sql.= 'client_sites b on b.client_id=a.id left outer join install_requests c on c.client_site_id=a.id ';
        $sql.= 'where ';
        $sql.= 'a.clientcategory = "'.$category.'" and a.branch_id in ('.$branch_id.') ';
        switch ($period){
            case  'y':
                //$sql.= "and date(a.create_date)>=date_sub('".$date."',interval dayofyear('".$date."') day) ";
                $sql.= "and year(c.create_date)=year('".$date."')";
                break;
            case 'q':
                $sql.= "and quarter(date(c.create_date))=quarter('".$date."') ";
                break;
            case 'm':
                $sql.= "and date(c.create_date)>=date_sub('".$date."',interval dayofmonth('".$date."') day) ";
                break;
            case 'w':
                $sql.= "and date(c.create_date)>=date_sub('".$date."',interval dayofweek('".$date."') day) ";
                break;
            case 'd':
                $sql.= "and date(c.create_date)='".$date."' ";
                break;
            }
    ...
    function gettroubleshootdetails($period,$category,$branch_id,$date){
        $branch_id = implode(",",explode("-",$branch_id));
        $date = date("Y-m-d");
        $sql = "select distinct a.id, ";
        ...
        $sql.= "left outer join clients c on c.id=b.client_id ";
        if($category=="0"){
            $sql.= "where (c.clientcategory not in ('1','2','3','4','5') or c.clientcategory is null)  ";
        }else{
            $sql.= "where c.clientcategory = '".$category."' ";
        }
        $sql.= "and c.branch_id in ($branch_id) ";
        switch ($period){
        case  'y':
            //$sql.= "and date(a.create_date)>=date_sub('".$date."',interval dayofyear('".$date."') day) ";
            $sql.= "and year(a.create_date)=year('".$date."')";
