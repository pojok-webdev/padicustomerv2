...
class Clients extends CI_Controller{
	...
	function installaddressdownload(){
		$clientexcel = $this->pclient->getinstalladdress();
        $data = array(
            'objs'=>$clientexcel['res'],
            'subject'=>'Alamat Instalasi Pelanggan ',
            'filename'=>'Alamat instalasi Pelanggan'
        );
        $this->load->view('Sales/Clients/installaddressexcel',$data);
	}
}
